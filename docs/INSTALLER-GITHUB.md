...
```bash
git add .
git commit -m "Update mql5-engineering to v2.8"
...
- `mql5-engineering-v2.8.zip`;
- `mql5-engineering-v2.8.zip.sha256`.
...
```bash
git add .
git commit -m "Release mql5-engineering v2.9"
git push origin main
git tag v2.9
